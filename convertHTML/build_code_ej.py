...
class CustomDataLoader(DataLoader):  
    ...
    def convert_num_to_html(self, coord_lst=None, category_lst=None, text=None, self_consistency=False, consistency_num=10):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_path", type=str, default="/workspace/ejbob/PosterNUWA/data/cgl_dataset")
    parser.add_argument("--save_path", type=str, default="/workspace/ejbob/PosterNUWA/debug")
    parser.add_argument("--model_path_or_name", type=str, default="/workspace/ejbob/PosterNUWA/models/Llama-2-7b-chat-hf", help="tokenizer model name")
    parser.add_argument("--bbox_quantization", type=str, default="code", choices=["code", "numerical"])
    parser.add_argument("--consistency_num", type=int, default=10, help="number of consistency num")
