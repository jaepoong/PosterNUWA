...
def main(args):
    ...
    for i in range(num_data):
        ...
        img.save("/workspace/ejbob/PosterNUWA/example/{:d}.png".format(i))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--pkl_path", type=str, default="/workspace/ejbob/PosterNUWA/data/combined_data.pkl", help='pkl file') 
